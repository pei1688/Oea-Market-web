...
const buttonVariants = cva(
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none  focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-fuchsia-600 text-background2 shadow-xs hover:bg-fuchsia-600/90",
        default2:
          "border border-fuchsia-500 text-background2 shadow-xs hover:bg-fuchsia-500/10",
        default3: "bg-primary text-background2 shadow-xs hover:bg-primary",
        variantChoose: "border border-primary text-primary",
        destructive:
        ...
        outline:
          "bg-neutral-200 shadow-xs hover:bg-neutral-700/20 dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost:
          "hover:bg-neutral-100/10 hover:text-accent-foreground dark:hover:bg-accent/50",
